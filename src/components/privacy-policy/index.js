      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            ...
            <p>
              Blue Rhine Industries LLC ("us", "we", or "our") operates the www.thecuttingcenter.com
              website (the "Service").
            </p>
            <p>
            ...
            <p>
              ...
              same meanings as in our Terms and Conditions, accessible from www.thecuttingcenter.com
            </p>
            ...
            <h3>USE OF DATA</h3>
            <p>Blue Rhine Industries LLC uses the collected data for various purposes:</p>
            <p>
              While using our Service, we may ask you to provide us with certain personally
              identifiable information that can be used to contact or identify you ("Personal
              Data"). Personally identifiable information may include, but is not limited to:
            ...
            <p>
              If you are located outside United Arab Emirates and choose to provide information to
              us, please note that we transfer the data, including Personal Data, to United Arab
              Emirates and process it there.
            </p>
            <p>
            ...
            <p>
              Blue Rhine Industries LLC will take all steps reasonably necessary to ensure that your
            ...
            <p>
              Blue Rhine Industries LLC may disclose your Personal Data in the good faith belief
              that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>
                To protect and defend the rights or property of Blue Rhine General Trading LLC
              </li>
            ...
            <p>
              {" "}
              <a href="support@thecuttingcenter.com">support@thecuttingcenter.com</a>
            </p>
          </div>
        </div>
      </div>
