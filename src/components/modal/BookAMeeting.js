...
const BookAMeetingMOdal = ({ showPriceModal, handleClosePriceModal }) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        size="lg schedule-meeting"
        centered
      >
        <Modal.Header closeButton></Modal.Header>
        <Modal.Body>
          <h4 className="modal-title modal-title-mid text-center">
            Schedule a Meeting
          </h4>
          <Formik
            initialValues={quote}
